...
print("Total head movement: " + str(metrics.head_movement_total(head_y, start, impact, height=height)))
...
print("Backswing hip rotation: " + str(metrics.back_hip_rotation(lhip_x, rhip_x, start, backswing)))
print("Followthrough hip rotation: " + str(metrics.thru_hip_rotation(lhip_x, rhip_x, impact, follow)))